...
ConVar mom_conc_effects_enable("mom_conc_effects_enable", "1", FCVAR_CHEAT, "Turn the conc effect on or off - 1 or 0.");
// TODO: Figure out why the flat ring effect doesn't work
ConVar mom_conc_refract("mom_conc_refract", "0", FCVAR_ARCHIVE,
...
{
    if (mom_conc_effects_enable.GetInt() == 0)
        return;
